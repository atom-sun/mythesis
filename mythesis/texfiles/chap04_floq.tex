...
\begin{align}\label{eq:Hmf}
    \hat{H}_{\text{mf}} &= \sum_{\langle i,j\rangle,\sigma} \left\{-J_0[(1-n_{A\bar{\sigma}})(1-n_{B\bar{\sigma}})+n_{A\bar{\sigma}}n_{B\bar{\sigma}}] - J_1[(1-n_{A\bar{\sigma}})n_{B\bar{\sigma}}+n_{A\bar{\sigma}}(1-n_{B\bar{\sigma}})]\right\}\hat{c}_{i\sigma}^{A\dagger}\hat{c}_{j\sigma}^B+ \text{H. C. } + \frac{\tilde{U}N}{2}(n_{A\uparrow}n_{A\downarrow} + n_{B\uparrow}n_{B\downarrow}) \notag \\
...
因此有
\begin{align}
\dfrac{\partial const.}{\partial \eta_c} &= Nc \\
\dfrac{\partial const.}{\partial \eta_s} &= Ns \\
\dfrac{\partial const.}{\partial c} &= (\tilde{U}c+\eta_c)N \\
\dfrac{\partial const.}{\partial s} &= (-\tilde{U}s+\eta_s)N 
\end{align}
